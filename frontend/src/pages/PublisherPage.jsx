    ...
    return (
      <div className="card p-8 text-center">
        <p className="text-gray-500 text-sm">
          No data yet. Check back shortly.
        </p>
      </div>
    );
...
export default function PublisherPage() {
  ...
  useEffect(() => {
    loadHourly(hourlyDays, stateFilter);
  }, [hourlyDays, stateFilter]);
      ...
      <header className="border-b border-surface-border bg-surface/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-display text-sm text-white tracking-widest uppercase">
                Publisher Dashboard
              </span>
              <span className="hidden sm:inline text-gray-600 text-xs ml-3">
                Combined Agent Availability
              </span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 text-xs text-gray-500">
              ...
              <span className="font-display">
                Refreshes in {autoRefreshSecs}s
              </span>
            </div>
            <button
